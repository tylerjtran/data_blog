...
```{r, out.width='70%', fig.align='center', fig.alt='A hand-drawn radar graph from 1955 showing the number of car crashes visualized by time of day'}
...
```{r, layout='l-body-outset', fig.width=6, fig.height=6, out.width='70%', fig.retina=1.2, fig.align = 'center', message=F, warning=F, echo=F, results = 'hide', preview = T, fig.alt='A radar graph of car crashes from 2019 visualized by time of day'}
...
```{r, layout='l-body-outset', fig.width=6, fig.height=6, out.width='70%', fig.retina=1.2, fig.align='center',message=F, warning=F, echo=F, results = 'hide', fig.alt='A radar graph of car crashes from 2019 visualized by time of day, comparing pre-pandemic data to pandemic data'}
