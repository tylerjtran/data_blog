...
```{r, layout='l-body-outset', fig.width=9.5, fig.height=6, out.width='100%', fig.retina=1, fig.align = 'center', message=F, warning=F, echo=F, results = 'hide'}
...
```{r, layout='l-body-outset', fig.width=6, fig.height=6, out.width='100%', fig.retina=1, fig.align='center',message=F, warning=F, echo=F}
...
```{r, layout='l-body-outset', fig.width=13, fig.height=6, out.width='100%', fig.retina=1, fig.align='center',message=F, warning=F, echo=F, results = 'hide'}
...
indego_daily_sample %>%
  ...
  annotate('text', x = ymd('2021-07-01'), y = 450, label = 'Predicted rides',
           fontface = 'bold', col = 'darkred', hjust = 0) +
...
I'd say the model predicted number of rides...fine. Could have been better, could have been worse.
...
```{r, layout='l-body-outset', fig.width=8, fig.height=6, out.width='100%', fig.retina=1, fig.align='center',message=F, warning=F, echo=F, results = 'hide', preview = T}
set.seed(164) 
