...
```{r, layout='l-body-outset', out.width='120%', fig.width=11.44, fig.height=4.32, fig.alt='Statements classified as virtually certain from an IPCC assessment report visualized as ocean waves, with a highlighted statement about sea level rise being virtually certain.'}
...
```{r, fig.alt='An animation of the Greenland Ice Sheet shrinking with a statement about the certainty of ice loss.'}
