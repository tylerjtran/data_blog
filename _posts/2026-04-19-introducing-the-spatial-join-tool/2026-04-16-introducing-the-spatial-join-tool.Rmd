...
I've jumped on the vibecoding train to build a browser-based tool to perform spatial joins. This is something that's doable with any GIS software or a couple lines of R or python code, but it won't require any technical setup and won't expose your data to any nefarious actors.
