...
```{r, layout='l-body-outset', out.width='120%', preview = T}
girafe(ggobj = p,
       options = list(
         opts_tooltip(
           css = "padding:3pt;font-family: Source Sans Pro;color:white;background-color:black;")),
...
Unfortunately, it doesn't look like the 1970 decennial census accounted for the number of Vietnamese residents per state, but the smaller red and blue dots in the graph above represent the Vietnamese population as of 1980. In the five years after the refugee camps closed, it seems that the states with the largest Vietnamese populations gained more people, while the states with the fewest Vietnamese residents tended to see shrinkage.
